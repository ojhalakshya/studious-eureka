...
const question = require('../config/question.json')
...
class Video extends Component {
  ...
  handSubmitAnswer = () => {
    this.setState(prevState => ({leaderBoard: prevState.leaderBoard.concat(prevState.username)}))
    let data = JSON.stringify({username : this.state.username, answers : this.state.answers})
  }
          ...
          <div>
            ...
            <div className="container">
              ...
              <Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
                <div style={{
                  borderStyle: "solid", borderColor: "#bdbdbd", margin: "5px", objectFit: "fill",
                  width: "30%", height: "98%"
                }}>
                  <p style={{
                    borderStyle: "solid", borderColor: "#bdbdbd", objectFit: "fill",
                  ...
                  <Input placeholder="Answer" value={this.answers} onChange={e => this.handleAnswers(e)} style={{
                    borderStyle: "solid", borderColor: "#bdbdbd", objectFit: "fill",
                    width: "100%", height: "48%"
                  }}>
                    Answer
                  </Input>
                  <Button variant="contained" color="primary" onClick={e => {this.handSubmitAnswer(e)}}>
                    Submit Answer
                  </Button>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    <h3>Leader Board</h3>
                    {this.state.leaderBoard.map((person) => (
                      <div>
                        {person}
                        <br/>
                      </div>
